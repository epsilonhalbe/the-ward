...
= Pre-made Characters<pre_made_characters>
...
#columns(2)[
=== Skills<careerist_skills>
#kult.skill-tree()
=== Stability<careerist_stability>
#kult.stability
=== Wounds<careerist_wounds>
#kult.wounds
...
==== Dark Secrets: Occult Experience<careerist_dark-secret>
...
#kult.move(
  title: "At any Cost",
  tag: "at-any-cost",
  description: [Whenever you truly desire something, you may take +2 to a roll by
decreasing *Stability* by *-2*.])

#kult.move(
  title: "Notorious",
  tag: "notorious",
  description: [ You are famous in your trade. Whenever you encounter someone who has
  likely heard about you:],
  attribute: kult.attrs.char.name,
  success: [
...
#kult.move(
  ...
  description: [
    ...
    Any you deal with a firearm is considered *+1 Harm*.
  ]
)
...
#columns(2)[
=== Skills<criminal_skills>
#kult.skill-tree()

=== Stability<criminal_stability>
#kult.stability

=== Wounds<criminal_wounds>
#kult.wounds
...
#kult.move(
  title: "Enforcer",
  tag: "enforcer",
  attribute: kult.attrs.viol.name,
  description: [
...
#kult.move(
  ...
  description: [
    ...
    you need to escape a dangerous situation, outline your plan:
  ],
  success: [
...
#kult.move(
  title: "Addict (Painkillers)",
  tag: "addict",
  attribute: kult.attrs.dis.name,
  description: [
    You are addicted to painkillers. In the first game session and whenever you
    have been using, or have the opportunity to use:
  ],
  success: [
...
#kult.move(
  ...
  complications: [
    Your condition triggers, causing pain and daze (to all rolls until the scene ends).
  ],
  failure: [
    Your condition is aggravated with life threatening results (*#kult.attrs.fort.move* with *2 Harm*).
  ],
)
]
...
#kult.move(
  title: "Expert (Neuroscience, Biology)",
  tag: "expert",
  description: [
    You are an expert in Neuroscience and Biology. Whenever you
    #kult.attrs.reas.move something associated with your expertise, you always
    get to ask one additional question, regardless of the outcome, and may ask
...
#kult.move(
  title: "Phobia (Confined Spaces)",
  tag: "disadvantage_phobia",
  attribute: kult.attrs.dis.move,
  description: [
...
#kult.move(
  ...
  description: [
    ...
    standard effects, whenever you *#kult.attrs.soul.move* and whenever the Illusion shatters, the
