...
#let skill-tree(
  ...
  let active(coord, body, value: none) = {
    let radius = 0.95
    circle(coord, radius: 0.95, stroke: 0.1cm + colors.primary , fill: colors.secondary.lighten(30%))
  ...
  let passive(coord, body, value: none) = {
    line((rel:(0 ,-1.1), to: coord),
         ...
         (rel:(-1.1,0), to: coord),
         (rel:(0,-1.1), to: coord),
         stroke: 1mm + colors.primary, close: true, fill: colors.secondary.lighten(30%))
